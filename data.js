...
const WPNS = {
    ...
    k98_scope: { name:"M1903 Scope", rng:9, acc:95, acc_drop:3, dmg:72, cap:5, mag:5, ap:2, rld:2, wgt:5, type:'bullet', burst:1, desc:"精密狙撃銃。", weight: 9, attr: ATTR.WEAPON }, // 名前を米軍風に変更
...
const UNIT_TEMPLATES = {
    ...
    // ◆フェーズ2: デバッグ用 迫撃砲兵 (Mortar Gunner)
    mortar_gunner: { 
        name: "Mortar Gunner", 
        role: "infantry", 
        main: null,
