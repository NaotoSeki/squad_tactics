...
class Game {
    ...
    async actionMove(u, p) {
        ...
        this.state = 'PLAY'; this.refreshUnitState(u); this.checkPhaseEnd();
    }
    checkReactionFire(u) {
    ...
    endTurn() {
        ...
        this.state = 'ANIM';
        const eyecatch = document.getElementById('eyecatch'); if (eyecatch) eyecatch.style.opacity = 1;
        ...
        setTimeout(async () => {
            ...
            for (let e of es) {
                ...
                e.ap = e.maxAp; const w = e.hands; if (!w) continue;
