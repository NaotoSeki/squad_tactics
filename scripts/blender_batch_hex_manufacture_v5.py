...
# ---------------------------------------------------------
# Modular Builders (V2 mechanics + Mud textures)
# ---------------------------------------------------------
def build_ground_rubble(parent, mats):
    # Organic scatter without the rigid hex base
    create_rubble(parent, center=(0, 0, 0), radius=2.2, count=random.randint(30, 50), material=mats['mud'])
    create_rubble(parent, center=(0, 0, 0), radius=1.8, count=random.randint(30, 50), material=mats['concrete'])
...
def build_wall_base(parent, mats):
    ...
    create_rubble(parent, center=(0.5, 0.5, 0), radius=1.2, count=random.randint(20, 30), material=mats['mud'])
    create_rubble(parent, center=(0.5, 0.5, 0), radius=1.0, count=random.randint(20, 30), material=mats['concrete'])
...
def main():
    ...
    out_dir = "C:/Projects/squad_tactics/asset/environment/hex_tiles_v5"
