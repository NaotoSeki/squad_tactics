...
def create_image_pbr_material(name, path_prefix, uv_scale=1.0):
    ...
    # V6 improvement: enhance brick color
    if "Brick" in name:
...
# ---------------------------------------------------------
# Modular Builders (V2 exact logic + Mud)
# ---------------------------------------------------------
def build_ground_rubble(parent, mats):
    # Clustered in center, not scattered wide (V2 style)
    create_rubble(parent, center=(0, 0, 0), radius=1.8, count=random.randint(20, 40), material=mats['mud'])
    create_rubble(parent, center=(0, 0, 0), radius=1.5, count=random.randint(20, 40), material=mats['concrete'])
...
def build_wall_base(parent, mats):
    ...
    create_rubble(parent, center=(0.5, 0.5, 0), radius=1.0, count=random.randint(15, 30), material=mats['concrete'])
    create_rubble(parent, center=(0.5, 0.5, 0), radius=1.2, count=random.randint(15, 30), material=mats['mud'])
...
def main():
    ...
    out_dir = "C:/Projects/squad_tactics/asset/environment/hex_tiles_v6"
